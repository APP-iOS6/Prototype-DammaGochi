...
- 사용 방법 안내 추가
- 방치형 캐릭터 환경 제작
- ~~사용자의 여러 반려동물 -> 다른 사용자의 반려동물 (커뮤니티형)~~
- 산책시키기 느낌 & 배경 움직이기
<br/>

### 케어존
- My 삭제 및 '카드 공유' 기능 추가
- 프로필에 나이정보 & 설정 추가 (설정 화면 구현)
- 외로움, 포만감 등 정보 확인 및 반려동물 이름 수정
<br/>

### 게임
- 동물 관련 게임으로 (산책, 간식 잘 받아먹기 등)
- 게임 상세페이지 제작 (1 ~ 2개 정도 간략한 구현)
<br/>

### 스토어
- 상품 갯수 추가 & disabled 를 제외 (여러 번 사고 싶은 경우)
<br/><br/>
